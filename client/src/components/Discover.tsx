...
import { StateDiscoverProvider, StateStargazersProvider } from '../selectors/stateContextSelector';
...
DiscoverRenderer.displayName = 'DiscoverRenderer';
