...
class SliderImage {
  constructor(options = {}) {
    ...
    this.opts = {
      ...
      sliderInner: options.sliderInner,
      slide: options.slide,
    ...
    this.slider = this.opts.slider;
    this.sliderInner = this.opts.sliderInner;
    this.slide = this.opts.slide;
    this.slidesNumb = this.slide.length;
  ...
  setBounds() {
    const bounds = this.slide[0].getBoundingClientRect();
