...
export function ForkIcon() {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="h-4 stroke-current feather feather-git-pull-request"
    >
      <circle data-v-6ce840f0="" cx="18" cy="18" r="3" />
      <circle data-v-6ce840f0="" cx="6" cy="6" r="3" />
      <path data-v-6ce840f0="" d="M13 6h3a2 2 0 0 1 2 2v7" />
      <line data-v-6ce840f0="" x1="6" y1="9" x2="6" y2="21" />
    </svg>
  );
}
export function DropDownShowIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
...
export function DropDownHideIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
