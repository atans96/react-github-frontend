        ...
        if (subscriber.optionsRef.current.shouldReconnect && subscriber.optionsRef.current.shouldReconnect(event)) {
          ...
          if (subscriber.reconnectCount.current < reconnectAttempts) {
            ...
            subscriber.optionsRef.current.onReconnectStop &&
              subscriber.optionsRef.current.onReconnectStop(subscriber.optionsRef.current.reconnectAttempts as number);
...
export const attachSharedListeners = (webSocketInstance: WebSocketLike, url: string) => {
