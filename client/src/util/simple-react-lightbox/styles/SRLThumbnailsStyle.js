...
export const SRLThumbnailGallery = styled.div`
  ...
  z-index: 9997;
  cursor: pointer;
  padding: ${(props) => (props.thumbnailsContainerPadding ? props.thumbnailsContainerPadding : '0')};
  background-color: ${(props) =>
    props.thumbnailsContainerBackgroundColor ? props.thumbnailsContainerBackgroundColor : 'transparent'};
...
export const SRLThumbnailGalleryImage = styled.a`
  width: ${(props) => (props.thumbnailsSize ? props.thumbnailsSize[0] : '80px')};
  height: ${(props) => (props.thumbnailsSize ? props.thumbnailsSize[1] : '80px')};
  background-repeat: no-repeat;
  background-size: cover;
  margin: ${(props) => (props.thumbnailsGap ? props.thumbnailsGap : '1px')};
  opacity: ${(props) => (props.thumbnailsOpacity ? props.thumbnailsOpacity : '0.4')};
  transition: 0.3s ease;
  will-change: opacity;
  display: block;
  cursor: draggable;
