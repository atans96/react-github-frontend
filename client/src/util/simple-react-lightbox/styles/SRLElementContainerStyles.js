...
export const SRLElementContainer = styled.div`
  ...
  width: 100vw;
  height: ${(props) =>
    props ? `calc(100vh - ${props.captionDivSizes.height + props.thumbnailsDivSizes.height}px)` : '100%'};
  ...
  @media (max-width: 768px) {
    ...
    height: ${(props) =>
      props
        ? `calc((var(--vh, 1vh) * 100) - ${props.captionDivSizes.height + props.thumbnailsDivSizes.height}px)`
        : '100%'};
  }
`;
