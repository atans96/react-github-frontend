...
class Issue extends Requestable {
  ...
  createIssue(issueData, cb) {
    return this._request(
      "POST",
      `/repos/${this.__repository}/issues`,
      issueData,
      cb
    );
  }
  ...
  listIssueEvents(issue, cb) {
    return this._request(
      "GET",
      `/repos/${this.__repository}/issues/${issue}/events`,
      null,
      cb
    );
  }
  ...
  listIssueComments(issue, cb) {
    return this._request(
      "GET",
      `/repos/${this.__repository}/issues/${issue}/comments`,
      null,
      cb
    );
  }
  ...
  getIssueComment(id, cb) {
    return this._request(
      "GET",
      `/repos/${this.__repository}/issues/comments/${id}`,
      null,
      cb
    );
  }
  ...
  editIssue(issue, issueData, cb) {
    return this._request(
      "PATCH",
      `/repos/${this.__repository}/issues/${issue}`,
      issueData,
      cb
    );
  }
  ...
  listMilestones(options, cb) {
    return this._request(
      "GET",
      `/repos/${this.__repository}/milestones`,
      options,
      cb
    );
  }
  ...
  getMilestone(milestone, cb) {
    return this._request(
      "GET",
      `/repos/${this.__repository}/milestones/${milestone}`,
      null,
      cb
    );
  }
  ...
  createLabel(labelData, cb) {
    return this._request(
      "POST",
      `/repos/${this.__repository}/labels`,
      labelData,
      cb
    );
  }
  ...
  getLabel(label, cb) {
    return this._request(
      "GET",
      `/repos/${this.__repository}/labels/${label}`,
      null,
      cb
    );
  }
